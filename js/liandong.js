...
var step = {
    ...
    Creat_Table: function () {
        ...
        $.each(SKUObj, function (i, item){
            ...
            columnIndex++;
            var order = new Array();
            if(SKUObj.find("input").eq(i).val()!=''&&SKUObj.find("input").eq(i).val()!=null){
                var itemName = $("ul[name='skuboxshow']")[i].id
                //选中的CHeckBox取值
                ...
                if(order.length!=0){
                    arrayTile.push(SKUObj.find("input").eq(i).val());
        ...
        if (bCheck == true) {
            ...
            $.each(arrayTile, function (index, item) {
                var td = $("<th name='skuallnum' >" + item + "</th>");
                td.appendTo(trHead);
            });
            var itemColumHead = $("<th  style=\"width:70px;\">数量</th><th style=\"width:70px;\">价格</th> ");
            ...
            if (zuheDate.length > 0) {
                ...
                $.each(zuheDate, function (index, item) {
                    ...
                    var td1 = $("<td ><input required=\"\" class=\"layui-input\" name=\"Txt_CountSon\" class=\"l-text\" type=\"text\" value=\"\"></td>");
                    td1.appendTo(tr);
                    var td2 = $("<td ><input required=\"\" class=\"layui-input\" name=\"Txt_PriceSon\" class=\"l-text\" type=\"text\" value=\"\"></td>");
                    td2.appendTo(tr);
...
// $(function () {
//     //SKU信息
//     $("#skucs input").bind("change", function () {
//         console.log(123)
//         step.Creat_Table();
//     });
//     var step = {
